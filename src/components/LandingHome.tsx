    ...
    ? [
        {
          ...
          status: 'HITL ACTIVE',
          description: 'Интерактивный диалог, уточнение недостающих параметров у клиента в чате, интеллектуальная маршрутизация обращений и моментальная передача подтверждённых заявок в 1С.',
        ...
        },
        {
          ...
          description: 'Управление интеграциями, мониторинг системных логов и трассировок выполнения ИИ-сценариев, Тонкая настройка процессов.',
        ...
        <div className="mx-auto max-w-[1200px] pt-[21px]">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className={`mt-[21px] max-w-[1000px] text-[15px] leading-[1.618] tracking-[-0.02em] sm:text-[16px] ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>
              ...
              рассчитывает SLA без ошибок и передает тикет напрямую в 1С.
            </p>
          </div>
