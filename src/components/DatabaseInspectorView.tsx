...
interface DatabaseInspectorViewProps {
  ...
  initialTab?: 'contractors' | 'sites' | 'assets' | 'contracts' | 'open_tickets' | 'closed_tickets';
}
...
export const DatabaseInspectorView: React.FC<DatabaseInspectorViewProps> = ({
  ...
  return (
    <div id="database-inspector-page" className="space-y-4 font-sans">
      {/* Header & Controls */}
      <div className="oc-card p-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
      ...
      {activeTab === 'contractors' && (
        <div
          className={`oc-card overflow-x-auto ${
            isDark
