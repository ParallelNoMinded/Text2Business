...
export const OperatorConsoleView: React.FC<OperatorConsoleViewProps> = ({
  ...
  return (
    <div id="operator-console-page" className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        {pendingTickets.length === 0 ? (
          <div className={`oc-card p-4 text-center text-xs font-mono ${isDark ? 'bg-[#030712] border-slate-800 text-slate-500' : 'bg-slate-100 border-slate-300 text-slate-900 font-semibold'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {pendingTickets.map((ticket) => (
              <div
                ...
                className={`oc-card p-4 transition-all cursor-pointer hover:scale-[1.01] ${
                  isDark
      ...
      <div className="space-y-3 pt-4">
        ...
        <div className={`oc-card overflow-x-auto ${isDark ? 'bg-[#060612]/90 border-cyan-500/20' : 'bg-white border-slate-300 shadow-sm'}`}>
