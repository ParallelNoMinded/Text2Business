...
export const ChannelsConfigView: React.FC<ChannelsConfigViewProps> = ({
  ...
  return (
    <div id="channels-config-page" className="space-y-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div
          className={`oc-card p-4 flex flex-col justify-between ${
            isDark
        ...
        <div
          className={`oc-card p-4 flex flex-col justify-between lg:col-span-2 ${
            isDark
