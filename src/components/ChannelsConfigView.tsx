              ...
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  <h3 className={`text-sm font-mono font-bold uppercase ${isDark ? 'text-emerald-300' : 'text-blue-950'}`}>
                    4. API и вебхуки (REST API & Webhooks)
                  </h3>
                  <span className="text-[11px] text-slate-400 font-mono">
        ...
        >
          ...
          <div className="mt-4 pt-3 border-t border-slate-700/30 flex flex-col sm:flex-row items-center justify-between gap-3">
            <button
              ...
              className="voice-send-button w-full sm:w-auto py-2.5 px-6 rounded-xl bg-rose-500 hover:bg-rose-400 text-slate-950 font-mono text-xs font-bold transition-all shadow-md flex items-center justify-center space-x-2 disabled:opacity-50"
            >
              {isVoiceSubmitting ? (
                <>
                  <RefreshCw className="h-4 w-4 animate-spin" />
