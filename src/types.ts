/**
 * Типы данных проекта Text2Business.
 *
 * Структура файла:
 *  1. Извлечение фактов (Fact Extraction) — результат работы LLM.
 *  2. Модель БД: контрагенты, объекты, оборудование, договоры.
 *  3. Заявки (Tickets): сообщения, статусы, история.
 *  4. Служебные: системные логи, трассировка обработки (trace).
 *  5. Результат диспетчеризации: ProcessingResult.
 *  6. Тестовые сценарии (ScenarioPreset) для демо-стенда.
 */

// ─────────────────────────────────────────────────────────────
// 1. Извлечение фактов из обращения (LLM Fact Extraction)
// ─────────────────────────────────────────────────────────────
